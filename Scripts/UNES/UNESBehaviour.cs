...
using GorillaEntertainmentSystem.Scripts.UNES.Renderer;

namespace GorillaEntertainmentSystem.Scripts.UNES
{
    public class UNESBehaviour : MonoBehaviour
    {
        ...
        public bool _rendererRunning = true;
        ...
        private void InitInput()
        {
            ...
            if (Input == null) { Input = new DefaultInput();  }
        }
